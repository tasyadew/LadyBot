...
//Arduino Robot Car Wireless Control using the HC-05 Bluetooth
 ...
 /*define may need to be deleted as it is already defined in general
  *void setup may be terminated as it has a separate folder for it
  *best to just leave the motor functions in tab */
#define enA 9
#define in1 4
#define in2 5
#define enB 10
